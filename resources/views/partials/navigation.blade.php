<nav class="sticky-nav">
    ...
    <div class="nav-links">
        ...
        <a href="{{ url('/about-us') }}" style="font-size: 1.2rem; font-weight: bold; color: #333; transition: box-shadow 0.3s ease; border-radius: 8px; {{ request()->is('about') ? 'box-shadow: 0 0 15px rgba(51, 51, 51, 0.5);' : '' }}" onmouseover="this.style.boxShadow='0 0 15px rgba(51, 51, 51, 0.5)'" onmouseout="this.style.boxShadow='none'">About Us</a>
...
<div class="slider-menu animate__animated animate__slideInRight animate__faster" id="slider-menu">
    ...
    <div class="nav-links">
        ...
        <a href="{{ url('/about-us') }}" class="animate__animated animate__fadeInRight animate__faster animate__delay-1s" style="font-size: 1.2rem; font-weight: bold; {{ request()->is('about') ? 'color: #007bff;' : '' }}">About Us</a>
