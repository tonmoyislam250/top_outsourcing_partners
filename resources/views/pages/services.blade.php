...
<section class="hero-section animate__animated animate__fadeIn" style="padding: 50px 0; background: linear-gradient(to right, #f8f9fa, #e9ecef);">
    <div class="container" style="display: flex; align-items: center; justify-content: space-between;">
        <div class="hero-text animate__animated animate__fadeInLeft" style="max-width: 50%; text-align: left;">
...
<section class="service-section animate__animated animate__fadeInUp" style="padding: 50px 0; background-color: #f8f9fa;">
    <div class="container" style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap;">
        <div class="service-image animate__animated animate__zoomIn" style="flex: 1; max-width: 45%; padding-right: 20px;">
        ...
        <div class="service-text animate__animated animate__fadeInLeft" style="flex: 1; max-width: 50%; text-align: left;">
...
<section class="service-section animate__animated animate__fadeInUp" style="padding: 50px 0; background-color: #ffffff;">
    <div class="container" style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap;">
        <div class="service-text animate__animated animate__fadeInLeft" style="flex: 1; max-width: 50%; text-align: left; padding-right: 20px;">
        ...
        <div class="service-image animate__animated animate__zoomIn" style="flex: 1; max-width: 45%;">
