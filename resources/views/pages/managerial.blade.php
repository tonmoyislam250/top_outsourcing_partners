...
<section class="why-choose">
    <div class="container">
        <h2>Why Choose Our Employee Managerial Service?</h2>
        <div class="features-grid">
            <div class="feature-item">
                <img src="{{ asset('images/manager/image1.png') }}" alt="Dedicated Team" style="width: 100%; height: auto;">
                <h3 style="text-align: left;">A Dedicated Team That Works Only for You</h3>
            ...
            <div class="feature-item">
                <img src="{{ asset('images/manager/image2.png') }}" alt="Cost Saving" style="width: 100%; height: auto;">
                <h3 style="text-align: left;">Massive Cost Saving Without Compromising Quality</h3>
                <ul style="text-align: left;">
        ...
        <div class="features-grid">
            <div class="feature-item">
                ...
                <h3 style="text-align: left;">No Obligation, No Problem!</h3>
                <ul style="text-align: left;">
            ...
            <div class="feature-item">
                ...
                <h3 style="text-align: left;">Guaranteed Workforce Continuity - No Disruption</h3>
                <ul style="text-align: left;">
            ...
            <div class="feature-item">
                ...
                <h3 style="text-align: left;">Flexible Hiring Options</h3>
                <ul style="text-align: left;">
        ...
        <div class="enhancement-grid">
            <div class="row">
                ...
                <div class="enhancement-card" style="flex: 1; padding: 20px; box-sizing: border-box;">
                    ...
                    <div>
                        <h3 style="text-align: left;">Dedicated Team Performance Monitoring & Reporting</h3>
                        <ul style="text-align: left;">
                ...
                <div class="enhancement-card" style="flex: 1; padding: 20px; box-sizing: border-box;">
                    ...
                    <div>
                        <h3 style="text-align: left;">Legal & Compliance Advisory for Overseas Companies</h3>
                        <ul style="text-align: left;">
            ...
            <div class="row">
                ...
                <div class="enhancement-card" style="flex: 1; padding: 20px; box-sizing: border-box;">
                    ...
                    <div>
                        <h3 style="text-align: left;">Specialized Workforce Training & Upskilling Programs</h3>
                        <ul style="text-align: left;">
                ...
                <div class="enhancement-card" style="flex: 1; padding: 20px; box-sizing: border-box;">
                    ...
                    <div>
                        <h3 style="text-align: left;">Client–Branded Workspaces & Team Integration</h3>
                        <ul style="text-align: left;">
  ...
  <div class="container">
    ...
    <div class="benefit-grid">
      ...
      <div class="benefit-card">
        ...
        <div>
          <h3>Call Centers & Customer Support</h3>
      ...
      <div class="benefit-card">
        ...
        <div>
          <h3>Engineering & Design Firms</h3>
...
<section class="why-bangladesh">
  <div class="container">
    ...
    <div class="bangladesh-wrapper">
      <img src="{{ asset('images/manager/map.png') }}" alt="Bangladesh Map" class="map-img" style="width: 50%; height: 50%;">
