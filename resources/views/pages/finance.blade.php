...
<div class="stats">
    ...
    <div class="stat-box">
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-dollar-sign">
...
<div class="finance-service">
  <div class="finance-image-wrapper">
    <img src="{{ asset('images/finance/image3.png') }}" alt="AP Management"> <!-- Replace with actual AP image -->
    <div class="finance-badge">
...
<div class="finance-service reverse">
  <div class="finance-image-wrapper">
    <img src="{{ asset('images/finance/image4.png') }}" alt="AR & Billing Services"> <!-- Replace with actual AR image -->
    <div class="finance-badge">
