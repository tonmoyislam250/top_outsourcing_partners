...
<div class="contact-container" style="max-width: 100%; padding: 0 15px; box-sizing: border-box;">
    <div class="form-section animate__animated animate__fadeInLeft">
        <h2 class="animate__animated animate__fadeInDown"><strong>Contact us</strong></h2>
        <form id="contactForm" action="{{ route('contact.send') }}" method="POST">
            ...
            <button type="submit" class="submit-btn animate__animated animate__pulse animate__infinite animate__slower">Submit</button>
        </form>
    </div>

    <div class="contact-info animate__animated animate__fadeInRight">
        <h3 class="animate__animated animate__fadeInDown"><strong>Contact Via</strong></h3>
