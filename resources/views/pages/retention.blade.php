...
<div class="policy-container">
    <div class="policy-content">
        <h1>DATA RETENTION &amp; ERASURE POLICY</h1>

        <h2>1. Policy Statement</h2>
        <p class="lead-text">
            Top Outsourcing Partners ("TOP", "we", "our", or "the Company") recognizes that effective data and records 
            management is vital to fulfilling business objectives, meeting compliance standards, protecting personal data, 
            and ensuring operational excellence.
        </p>
        <p class="lead-text">This policy aligns with global best practices and aims to:</p>
        <ul>
        ...
        <h2>3. Scope</h2>
        <p class="lead-text">This policy applies to:</p>
        <ul>
        ...
        <p class="lead-text">Non-compliance may result in disciplinary action.</p>

        <h2>4. Legal Context (GDPR Alignment)</h2>
        <p class="lead-text">We collect personal data such as:</p>
        <ul>
        ...
        <h2>5. Objectives</h2>
        <p class="lead-text">TOP ensures data and records are:</p>
        <ul>
        ...
        <h2>6. Guidelines &amp; Procedures</h2>
        <h3>6.1 Retention Period Protocol</h3>
        <p class="lead-text">We periodically review all retained data to assess:</p>
        <ul>
        ...
        <h3>6.2 Designated Owners</h3>
        <p class="lead-text">Each system and record is assigned to an Information Asset Owner (IAO) who:</p>
        <ul>
        ...
        <h3>6.3 Document Classification</h3>
        <p class="lead-text">We classify all data into five levels:</p>
        <ul>
        ...
        <h3>6.4 Suspension for Legal Holds</h3>
        <p class="lead-text">In the event of:</p>
        <ul>
            <li>Litigation</li>
            <li>Legal notice</li>
        ...
        <h4>7.1.3 Internal Correspondence</h4>
        <ul>
        ...
        <h2>8. Right to Erasure ("Right to be Forgotten")</h2>
        <p class="lead-text">Individuals may request data erasure under GDPR if:</p>
        <ul>
        ...
        <h3>8.1 Special Category Data</h3>
        <p class="lead-text">For sensitive data, TOP ensures:</p>
        <ul>
        ...
        <h2>10. Roles &amp; Responsibilities</h2>
        <ul>
        ...
        <h2>Document Classification Levels</h2>
        <table>
            <thead>
                <tr>
